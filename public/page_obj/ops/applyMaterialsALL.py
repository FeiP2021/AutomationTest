...
testData = getyaml(setting.OPS_TEST_Element_YAML + '/' + 'applyMaterialsALL.yaml')
log = Log()
class applyMaterialsALL(Page):
    """
    备用物料申请页面
    """
    url = ''
    ...
    def applyMaterialsTestALL(self,materialstype):
        """
        提交物料申请
        :param materialstype:
        :return:
        ...
        Select(self.find_element(*self.applyMaterials_click2)).select_by_index(materialstype)
        sleep(2)
