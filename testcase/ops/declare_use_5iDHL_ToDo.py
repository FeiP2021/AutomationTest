...
try:
    f_daily_lottery =open(setting.OPS_TEST_DATA_YAML + '/' + 'declare_use_data.yaml',encoding='utf-8')
    declare_use_Data = yaml.load(f_daily_lottery)
...
class Demo_UI(myunit.MyTest):
    ...
    @ddt.data(*declare_use_Data)
    def test_declare_use(self,datayaml):
        """
        在线申报
